...
```console
sh LINUX/Installation/CONFIG/0.environnement.sh Debian buster SLDEBIAN04 LAN Europe Paris \
fr_FR.UTF-8 192.168.1.43 192.168.1.1 192.168.1.1 192.168.1.41 \
marc administrateur admin 1001 1001 root admin ;
```
...
sh LINUX/APPZ/Samba.sh ADD  marc Azerty74
sh LINUX/APPZ/Samba.sh DEL  marc
